...
```{r}
bf_ttest_df <- read_csv(here::here("./sim_data/bf_ttest_med.csv"))
bf_ttest_df_2 <- read_csv(here::here("./sim_data/bf_ttest_wide.csv"))
bf_ttest_df_3 <- read_csv(here::here("./sim_data/bf_ttest_ultwide.csv"))
bf_r_df <- read_csv(here::here("./sim_data/bf_ttest_df.csv"))
...
plot_prop_for_bf <- function(df){
  df |>
    ...
    labs(title = "Showing how Bayes Factor Become Unexpectedly Large", 
         subtitle = "Highlight Values Which Support Null Hypthesis")+
