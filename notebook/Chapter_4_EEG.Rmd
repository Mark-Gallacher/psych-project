...
# ggsave(plot = .eval_rope_g1[[2]], file = here::here("images/ch5", "fp_ropes.png"), width = 13, height = 10, dpi = 360)
```
...
grid.arrange(.eval_rope_g1[[1]] + labs(tag = "A"), 
             .eval_rope_g3[[2]] + labs(tag = "B"), 
             dyn_alpha_p1[[2]] + labs(tag = "C"), 
             dyn_alpha_p2[[2]] + labs(tag = "D"), 
             nrow = 2)

# ggsave(file = here::here("images/ch5", "fp_tp_grid.png"), width = 13, height = 10, dpi = 360)
```
